...
The same data is in [BOM.csv](BOM.csv), which can be uploaded to DigiKey's BOM Manager. The symbols in the schematic also carry `Manufacturer`, `MPN` and `DigiKey PN` fields.

### Board

|Ref|Qty|Value|Description|Package|Manufacturer|MPN|DigiKey|
|-|-|-|-|-|-|-|-|
...
|D1|1|PTVS15VS1UR|TVS diode, unidirectional, 15 V standoff, 400 W (cathode to RED)|SOD-123W|Nexperia|PTVS15VS1UR,115|[1727-5315-1-ND](https://www.digikey.com/en/products/result?keywords=1727-5315-1-ND)|
...
|-|-|-|-|-|-|
|H1|1|#6-32 × 1" nylon pan head Phillips machine screw (6.68 mm head), through the 4.0 mm hole|Essentra Components|010632PW100|DigiKey [RPC7858-ND](https://www.digikey.com/en/products/result?keywords=RPC7858-ND)|
|-|1|SnapSkru SPM Mini self-drilling drywall anchor (3/8"–5/8" drywall, #6–#8 screws)|TOGGLER|SnapSkru SPM Mini|Hardware stores; not stocked by DigiKey|
